...
function validateString($string){
	if( stripos($string, 'SELECT') !== false ||
		stripos($string, 'INSERT') !== false ||
		stripos($string, 'UNION') !== false ||
		stripos($string, 'DELETE') !== false ||
		stripos($string, 'UPDATE') !== false ||
		stripos($string, 'AND') !== false ||
		stripos($string, 'OR') !== false
	){
		return false;
	}
